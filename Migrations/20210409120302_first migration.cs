    ...
    public partial class firstmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Charles", "Leclerc", "Monégasque", 16, null });

            migrationBuilder.InsertData(
                table: "Driver",
                columns: new[] { "DriverId", "CareerId", "FirstName", "LastName", "Nationality", "RaceNumber", "TeamId" },
                values: new object[] { 2, 2, "Lando", "Norris", "British", 4, null });

            migrationBuilder.InsertData(
                table: "Driver",
                columns: new[] { "DriverId", "CareerId", "FirstName", "LastName", "Nationality", "RaceNumber", "TeamId" },
                values: new object[] { 3, 3, "Sebastian", "Vettel", "German", 5, null });
