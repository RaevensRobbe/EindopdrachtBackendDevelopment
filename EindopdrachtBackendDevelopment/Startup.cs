...
namespace EindopdrachtBackendDevelopment
{
    public class Startup
    {
        ...
        {
            options.Authority = "https://dev-1ctlli53.eu.auth0.com/";
            options.Audience = "eindopdrachtapi";
        });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "EindopdrachtBackendDevelopment", Version = "v1" });
            });
        }
        ...
        {
            //Swagger beschikbaar maken
            if (env.IsDevelopment() || env.IsEnvironment("Docker"))
            {
                app.UseDeveloperExceptionPage();
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "Eindopdracht v1"));
            }
